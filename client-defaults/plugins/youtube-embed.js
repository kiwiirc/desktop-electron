kiwi.plugin('youtube-embed', function(kiwi) {
    window.kiwi.state.$on("message.render", function(event){
        ...
        event.message.mentioned_urls.forEach(function(item,index){
            ...
            event.message.html = event.message.html + '<br /><div style="overflow:hidden;padding-bottom:56.25%;position:relative;height:0;"><iframe style="left:0;top:0;height:100%;width:100%;position:absolute;" src="https://www.youtube.com/embed/'+watchID+'" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>';
        });
    });
});